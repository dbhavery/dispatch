...
export const SITE_CONTENT = {
  ...
  navigation: {
    ...
    signInUrl: 'https://auth.dispatch.app',
    signUpUrl: 'https://auth.dispatch.app/signup',
    signInText: 'Sign In',
  ...
  hero: {
    ...
    primaryCta: {
      ...
      url: 'https://auth.dispatch.app/signup',
    },
    secondaryCta: {
      text: 'Watch Demo',
  ...
  cta: {
    ...
    buttonUrl: 'https://auth.dispatch.app/signup',
  },
